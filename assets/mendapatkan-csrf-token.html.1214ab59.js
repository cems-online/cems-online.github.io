import{_ as i,r as o,o as u,c as r,b as n,f as a,w as t,d as s,e as c}from"./app.007af5c0.js";const k={},d=n("h1",{id:"csrf-token",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#csrf-token","aria-hidden":"true"},"#"),s(" CSRF Token")],-1),m={class:"table-of-contents"},b=c('<h3 id="mendapatkan-csrf-xsrf-token" tabindex="-1"><a class="header-anchor" href="#mendapatkan-csrf-xsrf-token" aria-hidden="true">#</a> Mendapatkan CSRF / XSRF Token</h3><p>Berfungsi untuk mendapatkan csrf token.</p><table><thead><tr><th>Method</th><th>Path</th></tr></thead><tbody><tr><td>GET</td><td>/api/v1/ping</td></tr></tbody></table><p><strong>Contoh kode:</strong></p>',4),v=n("div",{class:"language-go line-numbers-mode","data-ext":"go"},[n("pre",{class:"language-go"},[n("code",null,[s(`
